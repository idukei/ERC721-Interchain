...
import {Token721Collateral} from "hyperlane-token/contracts/HypERC721Collateral.sol";
import {IERC721} from "@openzeppelin/contracts/token/ERC721/IERC721.sol";

/**
 * @title Hyperlane ERC721 Token Collateral that wraps an existing ERC721 with remote transfer functionality.
 */
contract BoletosInterchain is Token721Collateral {
    IERC721 public immutable wrappedToken;
     /**
     * @param erc721 Address of Boletos.sol
     */
